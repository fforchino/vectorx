...
function LoadEditIntentPage() {
    let intentName = QueryParams.id;

    intent = GetCustomIntentByName(intentName);
    document.getElementById("nameAdd").value = intent.name;
    document.getElementById("descriptionAdd").value = intent.description;
    document.getElementById("utterancesAdd").value = intent.utterances;
    document.getElementById("intentAddSelectintents").value = intent.intent;
    document.getElementById("paramnameAdd").value = intent.params.paramname;
    document.getElementById("paramvalueAdd").value = intent.params.paramvalue;
    document.getElementById("execAdd").value = intent.exec;
    document.getElementById("execAddArgs").value = intent.execargs;
}
...
function sendIntentAdd() {
    ...
    alert(WIREPOD_HOME+"/api/add_custom_intent?" + data);
    fetch(WIREPOD_HOME+"/api/add_custom_intent?" + data)
...
function sendLinkForm() {
    ...
    console.log(data)
    fetch(WIREPOD_HOME+"/link-esn-and-target?" + data)
    .then(response => response.text())
    .then((response) => {
...
function sendWeatherAPIKey(element) {
    ...
    fetch(WIREPOD_HOME+"/api/set_weather_api?" + data)
        .then(response => response.text())
        .then((response) => {
...
function updateWeatherAPI() {
    fetch(WIREPOD_HOME+"/api/get_weather_api")
        .then(response => response.text())
        .then((response) => {
...
function sendKGAPIKey(element) {
    ...
    result.innerHTML = '';
    result.appendChild(resultP);
    fetch(WIREPOD_HOME+"/api/set_kg_api?" + data)
        .then(response => response.text())
        .then((response) => {
            resultP.innerHTML = response
            result.innerHTML = '';
...
function updateKGAPI() {
    fetch(WIREPOD_HOME+"/api/get_kg_api")
        .then(response => response.text())
        .then((response) => {
            obj = JSON.parse(response);
...
function sendSTTLanguage() {
    ...
    result.innerHTML = '';
    result.appendChild(resultP);
    fetch(WIREPOD_HOME+"/api/set_stt_info?" + data)
        .then(response => response.text())
        .then((response) => {
            resultP.innerHTML = response
            result.innerHTML = '';
